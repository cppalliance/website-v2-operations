...
## GCP Notes for Administrators

This document is aimed at the administrators who create and maintain the cloud infrastructure, and it records
how each piece was set up. But you are more than welcome to read the other page,
[DEVELOPERS.md](./DEVELOPERS.md), which is aimed at developers who need day-to-day access to the running
services.
...
The gcloud and kubectl steps are the same for everyone. See
[Connect to the web server instances](./DEVELOPERS.md#connect-to-the-web-server-instances) in DEVELOPERS.md.
...
Cloud Logging, the GKE Observability tab, and the kubectl equivalents are described in
[Observability, Monitoring, Logs](./DEVELOPERS.md#observability-monitoring-logs) in DEVELOPERS.md. The same
instructions apply to administrators, so they are not repeated here.
