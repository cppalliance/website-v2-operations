...
- That release is uploaded to https://archives.boost.io/master/ or https://archives.boost.io/develop/. Additionally, the same release-tools script (ci_boost_release.py) uploads a copy of the files to Django's S3 bucket. More info about those S3 buckets in [aws](../aws/README.md).  
